...
Route::group(['prefix' => config('birch.admin_url'),'middleware' => 'auth'],function(){

    Route::get('admin','DashboardController@index')->middleware('perm:admin.dashboard')->name('admin.dashboard');
